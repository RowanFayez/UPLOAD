...
class AppColors {
  // Primary Colors
  static const Color primary = Color(0xFF0057A7);
  static const Color accentYellow = Color(0xFFF7D117);
  ...
  static const Color toastBackground = Color(0xCC2D3748);
  ...
  static const Color handleBar = Color(0xFFE0E0E0);
  ...
  // Product Colors
  static const Color productPrice = primary;
  static const Color productBackground = Colors.white;
